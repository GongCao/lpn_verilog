...
// EVOLVE-BLOCK-START
// Adjust backpressure threshold for Cr buffer to reduce stalls, especially in 4:2:0 mode.
// Ensures at least 128 "pixel-equivalent" slots are free in the Cr buffer (1024 - 896 = 128).
// This prevents premature backpressure to the IDCT stage, improving pipeline throughput.
assign inport_accept_o   = (y_level_w <= 32'd384 && cr_level_w <= 32'd896) | idle_o;
