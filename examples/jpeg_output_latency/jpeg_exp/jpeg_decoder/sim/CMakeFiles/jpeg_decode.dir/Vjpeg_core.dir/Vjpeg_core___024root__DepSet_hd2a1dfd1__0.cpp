...
#endif
                VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 32, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 32, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 32, "", "NBA region did not converge.");
            }
