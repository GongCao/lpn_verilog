...
VL_INLINE_OPT void Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9___nba_sequent__TOP__jpeg_core__u_jpeg_output__u_ram_y__u_ram__0(Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vjpeg_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9___nba_sequent__TOP__jpeg_core__u_jpeg_output__u_ram_y__u_ram__0\n"); );
    // Init
    ...
    vlSelf->__PVT__ram_read1_q = vlSelf->ram[vlSymsp->TOP__jpeg_core__u_jpeg_output__u_ram_y.__PVT__rd_ptr_q];
