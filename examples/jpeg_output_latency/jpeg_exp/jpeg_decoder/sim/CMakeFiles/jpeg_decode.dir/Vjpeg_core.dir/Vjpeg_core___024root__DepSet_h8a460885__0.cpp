...
void Vjpeg_core_jpeg_core___nba_sequent__TOP__jpeg_core__3(Vjpeg_core_jpeg_core* vlSelf);
...
void Vjpeg_core___024root___eval_nba(Vjpeg_core___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        ...
        Vjpeg_core_jpeg_core___nba_sequent__TOP__jpeg_core__3((&vlSymsp->TOP__jpeg_core));
