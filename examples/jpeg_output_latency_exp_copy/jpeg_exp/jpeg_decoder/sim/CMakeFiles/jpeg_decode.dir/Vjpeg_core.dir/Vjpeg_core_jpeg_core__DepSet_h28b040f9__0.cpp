...
VL_INLINE_OPT void Vjpeg_core_jpeg_core___nba_sequent__TOP__jpeg_core__3(Vjpeg_core_jpeg_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vjpeg_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vjpeg_core_jpeg_core___nba_sequent__TOP__jpeg_core__3\n"); );
    // Body
    if (vlSymsp->TOP.rst_i) {
