...
class Vjpeg_core_jpeg_bitbuffer final : public VerilatedModule {
  public:
    ...
    CData/*2:0*/ __PVT__rd_ptr_shift_pipe_q;
    CData/*6:0*/ __PVT__count_pipe_q;
    CData/*0:0*/ __PVT__drain_pipe_q;
    CData/*5:0*/ __PVT__outport_pop_pipe_q;
    CData/*6:0*/ __PVT__count_r;
    VL_OUT(__PVT__outport_data_o,31,0);
    QData/*39:0*/ __PVT__fifo_data_pipe_q;
