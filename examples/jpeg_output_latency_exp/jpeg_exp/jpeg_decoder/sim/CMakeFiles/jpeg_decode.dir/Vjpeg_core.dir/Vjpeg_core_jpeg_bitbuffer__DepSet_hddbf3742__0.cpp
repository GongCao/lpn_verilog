...
VL_INLINE_OPT void Vjpeg_core_jpeg_bitbuffer___nba_sequent__TOP__jpeg_core__u_jpeg_bitbuffer__0(Vjpeg_core_jpeg_bitbuffer* vlSelf) {
    ...
    if (vlSymsp->TOP.rst_i) {
        ...
        __Vdly__rd_ptr_q = 0U;
        vlSelf->__PVT__fifo_data_pipe_q = 0ULL;
        vlSelf->__PVT__rd_ptr_shift_pipe_q = 0U;
    } else {
        if (vlSymsp->TOP__jpeg_core.__PVT__u_jpeg_input__DOT__start_q) {
            ...
            vlSelf->__PVT__fifo_data_pipe_q = ((0x20U 
                                                   ...
                                                   ((8U 
                                                    ...
                                                    (((QData)((IData)(
                                                     ...
                                                     | (QData)((IData)(
                                                                       vlSelf->__PVT__ram_q
                                                                       [4U]))))));
            vlSelf->__PVT__rd_ptr_shift_pipe_q = (7U 
                                                  & (IData)(vlSelf->__PVT__rd_ptr_q));
        }
        vlSelf->__PVT__wr_ptr_q = __Vdly__wr_ptr_q;
    }
    ...
    vlSelf->__PVT__outport_data_o = (IData)((0xffffffffULL 
                                             & ((vlSelf->__PVT__fifo_data_pipe_q 
                                                ...
                                                >> 8U)));
    vlSelf->__PVT__drain_pipe_q = ((~ (IData)(vlSymsp->TOP.rst_i)) 
                                   & ((~ (IData)(vlSymsp->TOP__jpeg_core.__PVT__u_jpeg_input__DOT__start_q)) 
                                      & (IData)(vlSelf->__PVT__drain_q)));
    if (vlSymsp->TOP.rst_i) {
        vlSelf->__PVT__outport_pop_pipe_q = 0U;
        vlSelf->__PVT__count_pipe_q = 0U;
        ...
        vlSelf->__PVT__outport_pop_pipe_q = vlSymsp->TOP__jpeg_core__u_jpeg_mcu_proc.__PVT__pop_bits_r;
        vlSelf->__PVT__count_pipe_q = vlSelf->__PVT__count_q;
