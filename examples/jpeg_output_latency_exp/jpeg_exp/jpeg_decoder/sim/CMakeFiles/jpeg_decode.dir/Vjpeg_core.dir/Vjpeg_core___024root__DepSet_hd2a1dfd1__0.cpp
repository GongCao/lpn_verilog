...
#endif
                VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 159, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 159, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("../src_v/../src_v/jpeg_core.v", 159, "", "NBA region did not converge.");
            }
