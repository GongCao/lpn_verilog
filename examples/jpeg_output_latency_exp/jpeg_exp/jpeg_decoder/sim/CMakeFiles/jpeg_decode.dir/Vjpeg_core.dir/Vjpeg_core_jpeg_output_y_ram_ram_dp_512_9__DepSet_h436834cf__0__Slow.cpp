...
VL_ATTR_COLD void Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9___ctor_var_reset(Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vjpeg_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vjpeg_core_jpeg_output_y_ram_ram_dp_512_9___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__clk0_i = VL_RAND_RESET_I(1);
    vlSelf->__PVT__rst0_i = VL_RAND_RESET_I(1);
    vlSelf->__PVT__addr0_i = VL_RAND_RESET_I(9);
    ...
    vlSelf->__PVT__addr1_i = VL_RAND_RESET_I(9);
