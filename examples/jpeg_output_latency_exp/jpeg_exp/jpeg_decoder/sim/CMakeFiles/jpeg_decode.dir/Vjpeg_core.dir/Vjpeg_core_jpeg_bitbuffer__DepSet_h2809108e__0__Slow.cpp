...
VL_ATTR_COLD void Vjpeg_core_jpeg_bitbuffer___ctor_var_reset(Vjpeg_core_jpeg_bitbuffer* vlSelf) {
    ...
    vlSelf->__PVT__fifo_data_pipe_q = VL_RAND_RESET_Q(40);
    vlSelf->__PVT__rd_ptr_shift_pipe_q = VL_RAND_RESET_I(3);
    vlSelf->__PVT__count_pipe_q = VL_RAND_RESET_I(7);
    vlSelf->__PVT__drain_pipe_q = VL_RAND_RESET_I(1);
    vlSelf->__PVT__outport_pop_pipe_q = VL_RAND_RESET_I(6);
