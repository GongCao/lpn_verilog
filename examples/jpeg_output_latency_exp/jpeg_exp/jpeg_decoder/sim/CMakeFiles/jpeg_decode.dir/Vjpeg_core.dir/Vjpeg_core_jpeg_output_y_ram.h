...
class Vjpeg_core_jpeg_output_y_ram final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vjpeg_core_jpeg_output_y_ram(Vjpeg_core__Syms* symsp, const char* v__name);
    ~Vjpeg_core_jpeg_output_y_ram();
    VL_UNCOPYABLE(Vjpeg_core_jpeg_output_y_ram);
