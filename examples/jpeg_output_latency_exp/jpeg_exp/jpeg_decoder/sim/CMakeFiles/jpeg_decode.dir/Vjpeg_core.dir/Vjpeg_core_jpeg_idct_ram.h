...
#ifndef VERILATED_VJPEG_CORE_JPEG_IDCT_RAM_H_
#define VERILATED_VJPEG_CORE_JPEG_IDCT_RAM_H_  // guard
...
class Vjpeg_core_jpeg_idct_ram final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vjpeg_core_jpeg_idct_ram(Vjpeg_core__Syms* symsp, const char* v__name);
    ~Vjpeg_core_jpeg_idct_ram();
    VL_UNCOPYABLE(Vjpeg_core_jpeg_idct_ram);
